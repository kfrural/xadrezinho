...
public boolean verificarFimDeJogo() {
 ...
 public boolean isReiEmCheque() {
    // Verificar se o rei branco está em cheque
    if (isVezPecasBrancas) {
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                Peca peca = tabuleiro[i][j];
                if (peca != null && peca.getIsBranca() == false) {
                    if (peca.movimentoValido(4, 0, tabuleiro) || peca.movimentoValido(4, 1, tabuleiro) || peca.movimentoValido(4, 2, tabuleiro) || peca.movimentoValido(4, 3, tabuleiro) || peca.movimentoValido(4, 4, tabuleiro) || peca.movimentoValido(4, 5, tabuleiro) || peca.movimentoValido(4, 6, tabuleiro) || peca.movimentoValido(4, 7, tabuleiro)) {
                        return true;
                    }
                }
            }
        ...
        // Verificar se o rei preto está em cheque
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                Peca peca = tabuleiro[i][j];
                if (peca != null && peca.getIsBranca()) {
                    if (peca.movimentoValido(3, 0, tabuleiro) || peca.movimentoValido(3, 1, tabuleiro) || peca.movimentoValido(3, 2, tabuleiro) || peca.movimentoValido(3, 3, tabuleiro) || peca.movimentoValido(3, 4, tabuleiro) || peca.movimentoValido(3, 5, tabuleiro) || peca.movimentoValido(3, 6, tabuleiro) || peca.movimentoValido(3, 7, tabuleiro)) {
                        return true;
                    }
                }
            }
